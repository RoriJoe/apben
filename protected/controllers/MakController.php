...
class MakController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Mak');
	...
	{
		$model=new Mak('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Mak']))
			$model->attributes=$_GET['Mak'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mak-form')
		{
