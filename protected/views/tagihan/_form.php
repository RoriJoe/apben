...
<?php else: ?>
    <div class='row-tagihan'>
        ...
        : <b><?php echo $model->kode_output; ?></b>
    </div>
<?php endif; ?>

<?php if ($editable['kode_suboutput']): ?>
    <?php echo $form->dropDownListRow($model, 'kode_suboutput', MasterSuboutput::getDropDownList(false), array('class' => 'span5', 'maxlength' => 25)); ?>
    <div class="clearfix"></div>
<?php else: ?>
    <div class='row-tagihan'>
        <span class='label-tagihan'>
        ...
        : <b><?php echo $model->kode_suboutput; ?></b>
    </div>
<?php endif; ?>
